...
from .views import CreateUserAPIView, LogoutUserAPIView, SendMessage, CheckMessage, GetSubjects, GetQuestions, GetRating, GetBattle, GetQuestionsForBattle, GetResult, LoginToken, Profile, ProfileGet,battle,searchBattle, SavePushToken, SendPush,GetOpponent
...
urlpatterns = [
    ...
    path("GetOpponent/", GetOpponent.as_view(), name="get_opponent"), 
    ...
    path("sendPush/", SendPush.as_view(), name="send_push"),    
    path("savePush/", SavePushToken.as_view(), name="save_push_token"),    
