          ...
          <Layout level="3" style={styles.layoutMain}>
            ...
            <Layout style={styles.layoutMain2}>
              ...
              <Divider style={{alignSelf:'stretch', borderWidth:0.5,marginBottom:10}} />
                ...
                />
                {loading?<Button style={styles.button} appearance='outline' icon={LoadingIndicator}>Проверка...</Button>:<Button style={styles.button} onPress={onChangeCheck} >Подтвердить</Button>}
