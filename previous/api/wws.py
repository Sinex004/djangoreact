...
SMSC_LOGIN = "sinex"            # логин клиента
SMSC_PASSWORD = "sinex13579"    # пароль
...
class SMSC(object):
    ...
    def send_sms(self, phones, message, translit=0, time="", id=0, format=0, sender=True, query=""):
...
smsc = SMSC()
smsc.send_sms("77785568094", "Ваш код: 667", sender="sms")